...
<?php 
    $p1 = new Personnage("Luke","player.png",27,Personnage::HOMME,Personnage::FORCE_MAX,Personnage::AGILITE_MED);//Personnage:: = pour appeler une constante d'une class qui est ds le fichier pooPersonnage.class.php
    ...
    $persos = Personnage::getListePersonnage();//pour pouvoir accéder à la class personnage(personnage::) 

    foreach($persos as $perso){
        $perso->afficherMesInformationsTemplate(); //Pour afficher à tour de rôle les personnages
        echo "<br/>-------------------------------<br/>";
    }
