...
if(isset($_POST['nb']) && $_POST['nb'] >0){
    $nbNotes = $_POST['nb'];
    for($i = 1; $i <= $nbNotes ; $i++){
        echo'<label for="nb">Note : . $</label>' ;//Pour générer un input, si on tape 5, 5 inputs s'afficheront//Bien mettre de simple guillemet car il y à l'intérieur des doubles guillemets et cela risque de  faire conflit
