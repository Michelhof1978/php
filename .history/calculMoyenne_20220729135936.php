...
if(isset($_POST['nb']) && $_POST['nb'] >0){
    $nbNotes = $_POST['nb'];
    for($i = 1; $i <= $nbNotes ; $i++){
        echo"<label for=\"nb\"> Note . $i  .  :</label>" ;//Pour générer un input, si on tape 5, 5 inputs s'afficheront//Bien mettre \ quand  guillemet à l'intérieur car risque conflits// Note . $i = pour chiffrer de 1 à 
