...
//Notez que la fonction de construction commence par deux traits de soulignement (__) !
    ...
    function getNom(){return $this->nom;}// Le getter (getNomva retourner les infos de l'attribut "nom" pour lequel on aura besoins d'y accéder sinon, ça sera le setter
