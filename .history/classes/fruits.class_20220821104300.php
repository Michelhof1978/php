...
class Fruit{
    ...
    private function getAffichageIMG(){//fonction pour afficher image
        if($this->nom === self::POMME){//si
            return "<img src ='images/apple.png".self::POMMEIMG."' alt='image pomme' /> <br/>";
        } else if ($this->nom === self::CERISE){
            return "<img src ='images/cherry.png".self::CHERRYIMG."' alt='image cerise' /><br/>";
        }
    }
