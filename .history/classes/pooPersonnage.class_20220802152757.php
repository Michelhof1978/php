...
//Notez que la fonction de construction commence par deux traits de soulignement (__) !
        ...
        self::$personnages[] = $this;//$this = prends la valeur de this(objet que l'on est en train créer)// Pour y accéder directement via la class personnage, on sera obligé de mettre sel
    }
