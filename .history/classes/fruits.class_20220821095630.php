...
class Fruit{
    ...
    const POMME = "pomme";//const = constante, la valeur ne pourra pas être modifiée//Les constantes sont sensibles à la casse(qu'il y est ). Par convention, les constantes sont toujours en majuscule.
    const CERISE = "cerise";
