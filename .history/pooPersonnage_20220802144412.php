...
//Notez que la fonction de construction commence par deux traits de soulignement (__) !
    ...
    function getNom(){return $this->nom;}// Le getter ( getNom() )va retourner les infos(valeurs) de l'attribut "nom" pour lequel on aura besoins d'y accéder sinon, ça sera le setter ( setNom() ) pour vouloir modifier
