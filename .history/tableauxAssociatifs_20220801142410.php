...
<?php 
    ...
    function afficherPerso($personnage){//Création de la variable $personnage (tableau) // A chaque tours de boucle, nous allons stocker les infos ds une variable $value
