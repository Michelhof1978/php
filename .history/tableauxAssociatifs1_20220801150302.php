...
$p1 = [
    ...
    $p3 = [
        "Nom" => "Marc",// Nom = index // marc = valeur
        "Age" => 33,
        "Sexe" => "Homme",
        "Force" => 7,
        "Agilite" =>2
...
<?php 
    if(!isset($_POST['perso']) || $_POST['perso'] === "p1"){
        ...
        echo "</div>";
        echo "<div class='gauche'>";
            afficherPerso($p1);//Affichage personnage 1 en premier 
        echo "</div>";
        ...
        echo "</div>";
        echo "<div class='gauche'>";
            afficherPerso($p2);//Affichage personnage 2 à chaque tour de boucle
        echo "</div>";
        ...
        echo "</div>";
        echo "<div class='gauche'>";
            afficherPerso($p3);//Affichage de chaque personnage à chaque tour de boucle
        echo "</div>";
    }
    ...
    function afficherPerso($personnage){//Création de la variable $personnage (tableau) 
        foreach($personnage as $index => $value){//$index = clé du tableau(nom, age....) // A chaque tours de boucle, nous allons stocker les infos ds une variable $value
           //$index => $value sont tous les 2 des variables temporaires que l'on vient de créer
            echo "<b>".$index."</b> : ". $value . "<br/>";//afficher les clés et valeurs
        }
