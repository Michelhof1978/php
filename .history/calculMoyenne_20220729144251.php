...
if(isset($_GET['nb']) && $_GET['nb'] >0){
    ...
    for($i = 1; $i <= $nbNotes ; $i++){
        ...
        if(isset($_GET['note1'])){//On va tester si une valeur de note 1 a été saisi par rapport à l étape du if ci-dessus
          //Bien mettre en POST ici sinon le calcul de la moyenne ne s'affichera pas
