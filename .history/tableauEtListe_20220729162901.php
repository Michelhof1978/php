...
<form action="#" method="POST">
    ...
    <select name="perso" id="perso" onChange = "submit()">
        <option value="p1" <?php if(isset($_POST['perso']) && $_POST['perso'] === "p1") echo "selected"?>>Luke</option><!--Le if, c'est pour conserver et vérifier la valeur de POST de perso, si c'est le cas, -->
