...
class Personnage{
    ...
    private $img;
    private $age;//private = sera accéssible de nul part, si ce n'est de la class elle même // public = accébible n'importe où par n'importe qui
    private $sexe;
    private $force;
    private $agilite;
...
//Notez que la fonction de construction commence par deux traits de soulignement (__) !
    ...
    function getNom(){return $this->nom;}// Le getter ( getNom() )va retourner les infos(valeurs) de l'attribut "nom" pour lequel on aura besoins d'y accéder sinon, ça sera le setter ( setNom() ) pour modifier l'infos
