...
<form action="#" method="GET"> <!--on passe en GET ici pour pouvoir conserver les champs(inputs) car si on était en POST , on ne pourrat pas soumettre le 2 ème formulaire car nb -->
